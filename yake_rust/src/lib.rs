...
mod tests {
    ...
    fn keywords() {
        ...
        let results: Results = vec![
            ResultItem { raw: "Kaggle".to_owned(), keyword: "kaggle".to_owned(), score: 0.20846279315962324 },
            ResultItem { raw: "Google".to_owned(), keyword: "google".to_owned(), score: 0.23676437642810488 },
            ResultItem { raw: "acquiring Kaggle".to_owned(), keyword: "acquiring kaggle".to_owned(), score: 0.3017882425537463 },
            ResultItem { raw: "data science".to_owned(), keyword: "data science".to_owned(), score: 0.30873986543219967 },
            ResultItem { raw: "Google Cloud".to_owned(), keyword: "google cloud".to_owned(), score: 0.40955463454967833 },
            ResultItem { raw: "Google Cloud Platform".to_owned(), keyword: "google cloud platform".to_owned(), score: 0.5018536215405839 },
            ResultItem { raw: "acquiring data science".to_owned(), keyword: "acquiring data science".to_owned(), score: 0.5494143207629893 },
            ResultItem { raw: "San Francisco".to_owned(), keyword: "san francisco".to_owned(), score: 0.7636151899513093 },
            ResultItem { raw: "CEO Anthony Goldbloom".to_owned(), keyword: "ceo anthony goldbloom".to_owned(), score: 0.8166005339007906 },
            ResultItem { raw: "science community Kaggle".to_owned(), keyword: "science community kaggle".to_owned(), score: 0.8690005548383123 },
        ];
